...
pub async fn on_msg(
    ...
    // TODO: Clean up uncompleted matches after a certain amount of time (challenged, accepted, etc)
    // TODO: Add categories command
    // TODO: add command for adding new questions
    // TODO: prevent users from wagering more points than they have
    // TODO: add command for top 3 duelists
    // TODO: add rematch command (double or nothing)
    // TODO: add KDA command
    // TODO: add ranking command
